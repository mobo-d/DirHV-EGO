function X = srgtsESEAOLHSdesign(npoints, ndv, maxiter, maxstalliter)
...
%------------------------------- Reference --------------------------------
% Jin, Ruichen, Wei Chen, and Agus Sudjianto. "An efficient algorithm for 
% constructing optimal design of computer experiments." In International 
% Design Engineering Technical Conferences and Computers and Information 
% in Engineering Conference, vol. 37009, pp. 545-554. 2003.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% initial LHD
